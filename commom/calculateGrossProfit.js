...
function calculateGrossProfit(total, list) {
...
function serviceChargeCalculate(obj) {
    ...
    return (Number(businessVolume) * Number(estimatedProportion) / 100 * Number(exchangeRate)).toFixed(2);
}
...
module.exports = calculateGrossProfit;